...
# load local image
file = here::here("doas", "miller.jpg")
...
ggsave(here::here("doas", "salesmanTSP.png"), dpi=600, width = 4, height = 5)

# save data for transformer
write_csv(data_to_plot, here::here("doas", "data_to_plot.csv"))
write_csv(order, here::here("doas", "order.csv"))
