...
# load local image
file = here::here("archness", "cheryl", "cheryl.jpg")
...
ggsave(here::here("archness", "cheryl", "cherylTSP.png"), dpi=600, width = 4, height = 5)

# save data for transformer
write_csv(data_to_plot, here::here("archness", "cheryl", "data_to_plot.csv"))
write_csv(order, here::here("archness", "cheryl", "order.csv"))
