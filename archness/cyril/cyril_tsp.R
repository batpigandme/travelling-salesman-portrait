...
# load local image
file = here::here("archness", "cyril", "cyril.jpg")
...
ggsave(here::here("archness", "cyril", "cyrilTSP.png"), dpi=600, width = 4, height = 5)

# save data for transformer
write_csv(data_to_plot, here::here("archness", "cyril", "data_to_plot.csv"))
write_csv(order, here::here("archness", "cyril", "order.csv"))
