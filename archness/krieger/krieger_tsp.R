...
# load local image
file = here::here("archness", "krieger", "krieger.jpg")
...
ggsave(here::here("archness", "krieger", "kriegerTSP.png"), dpi=600, width = 4, height = 5)

# save data for transformer
write_csv(data_to_plot, here::here("archness", "krieger", "data_to_plot.csv"))
write_csv(order, here::here("archness", "krieger", "order.csv"))
