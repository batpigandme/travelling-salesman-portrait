...
# load local image
file = here::here("archness", "malory", "malory.jpg")
...
ggsave(here::here("archness", "malory", "maloryTSP.png"), dpi=600, width = 4, height = 5)

# save data for transformer
write_csv(data_to_plot, here::here("archness", "malory", "data_to_plot.csv"))
write_csv(order, here::here("archness", "malory", "order.csv"))
