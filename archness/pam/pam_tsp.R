...
# load local image
file = here::here("archness", "pam", "pampoovey.jpg")
...
ggsave(here::here("archness", "pam", "pamTSP.png"), dpi=600, width = 4, height = 5)

# save data for transformer
write_csv(data_to_plot, here::here("archness", "pam", "data_to_plot.csv"))
write_csv(order, here::here("archness", "pam", "order.csv"))
