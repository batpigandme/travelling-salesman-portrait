...
# load local image
file = here::here("archness", "archer", "archer_headshot.jpg")
...
ggsave(here::here("archness", "archer", "archerTSP.png"), dpi=600, width = 4, height = 5)

# save data for transformer
write_csv(data_to_plot, here::here("archness", "archer", "data_to_plot.csv"))
write_csv(order, here::here("archness", "archer", "order.csv"))
