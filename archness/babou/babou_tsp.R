...
# load local image
file = here::here("archness", "babou", "babou_header.jpg")
...
ggsave(here::here("archness", "babou", "babouTSP.png"), dpi=600, width = 4, height = 5)

# save data for transformer
write_csv(data_to_plot, here::here("archness", "babou", "data_to_plot.csv"))
write_csv(order, here::here("archness", "babou", "order.csv"))
